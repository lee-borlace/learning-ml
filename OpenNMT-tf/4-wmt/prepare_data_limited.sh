...
# curl http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz > training-parallel-commoncrawl.tgz
...
# curl  http://www.statmt.org/wmt13/training-parallel-europarl-v7.tgz > training-parallel-europarl-v7.tgz
...
# curl  http://data.statmt.org/wmt16/translation-task/training-parallel-nc-v11.tgz > training-parallel-nc-v11.tgz
...
# curl  http://www.statmt.org/wmt14/test-filtered.tgz > test-filtered.tgz
# echo "Downloading and extracting newstest2017 data (5 MB) for testing..."
# curl  http://data.statmt.org/wmt17/translation-task/test.tgz > test.tgz
...
# curl -nc https://raw.githubusercontent.com/OpenNMT/OpenNMT-tf/master/third_party/input-from-sgm.perl > input-from-sgm.perl
